...
public:
    ...
    void SetUniformMat4(const std::string &name, const glm::mat<4, 4, glm::f32, glm::packed_highp>& mat, bool transpose = false);
    ...
    static void SetShaderUniformMat4(const Shader &shader, const std::string &name, const glm::mat<4, 4, glm::f32, glm::packed_highp>& mat, bool transpose = false);
    ...
    static void SetUniformMat4(int32_t location, const glm::mat<4, 4, glm::f32, glm::packed_highp>& mat, bool transpose = false);
